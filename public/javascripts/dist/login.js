...
var _defineProperty2 = __webpack_require__(434);
...
var Login_Form = function (_React$Component) {
	(0, _inherits3.default)(Login_Form, _React$Component);

	function Login_Form(props) {
		(0, _classCallCheck3.default)(this, Login_Form);

		var _this = (0, _possibleConstructorReturn3.default)(this, (Login_Form.__proto__ || (0, _getPrototypeOf2.default)(Login_Form)).call(this, props));

		_this.state = { login: (0, _defineProperty3.default)({
				url: 'login',
				method: 'post',
	...
	(0, _createClass3.default)(Login_Form, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'form',
				{ action: this.state.login.url, method: this.state.login.method },
				...
				_react2.default.createElement(
					'label',
					null,
					_react2.default.createElement('input', { name: 'username', placeholder: '\u8D26\u53F7/\u90AE\u7BB1/\u624B\u673A', type: 'text', required: true })
				),
				_react2.default.createElement(
					'label',
					null,
					_react2.default.createElement('input', { name: 'password', placeholder: '\u5BC6\u7801', type: 'password', required: true })
				),
				_react2.default.createElement(
					'label',
					null,
					_react2.default.createElement('input', { id: 'submit_input', type: 'submit', value: '\u767B\u5F55' })
				),
				_react2.default.createElement(
					'a',
					{ id: 'register', href: this.state.login.register_url },
					'\u6CE8\u518C'
				)
			);
		}
...
var login_form = _react2.default.createElement(Login_Form, null);

_reactDom2.default.render(login_form, document.getElementById('login'));
