...
function drawImage(editor) {
	...
	var stat = getState(cm);
	var options = editor.options;
	var url = editor.options.imageURL;//修改simplemde代码
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(42), __webpack_require__(168), __webpack_require__(235));
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(42), __webpack_require__(167), __webpack_require__(169));
  else if (typeof define == "function" && define.amd) // AMD
